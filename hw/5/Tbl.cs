    ...
    public class Tbl
    {
      ...
      public List<Col> Cols = new List<Col>();
        ...
        public class Row
        {
            ...
            public Cell AddCell(string value, CellType t, Col colDef, int rowNum)
            {
                var cell = new Cell(value, t, colDef,rowNum);
                Cells.Add(cell);
                return cell;
            }
        ...
        public class Cell
        {
            ...
            private Col _colDef;
            private int _index; //original index in dataset for when other columns get split/sorted/etc
            public Cell(string raw, CellType t, Col colDef, int rowNum)
            {
            ...
            public bool IsDifferent(Cell other, double epsilon)
            {
                if (this.IsNumeric() && other.IsNumeric())
                {
                    return NumericValue - other.NumericValue > epsilon;
                }
                else
                {
